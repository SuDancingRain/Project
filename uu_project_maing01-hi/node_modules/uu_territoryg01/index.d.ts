...
declare namespace UuTerritory {
    namespace Activity {
        namespace Bricks {
            ...
            interface DetailGeneric$Props {
                ...
                solversLabel?: string;
                elementaryStateFilterFn?(...args: any): any;
            }
        ...
        namespace Core {
            interface ActivityTileChat$activityData {
            }
            interface ActivityTileChat$artifactData {
            }
            interface ActivityTileChat$Props {
                territoryBaseUri?: string;
                activityData: ActivityTileChat$activityData;
                artifactData?: ActivityTileChat$artifactData;
                type?: string;
                hideActions?: boolean;
                hideSubmitter?: boolean;
                hideDate?: boolean;
            ...
            function ActivityTileChat(props: ActivityTileChat$Props): any;
            ...
            interface ActivityTileProblem$activityData {
            }
            interface ActivityTileProblem$artifactData {
            }
            interface ActivityTileProblem$Props {
                territoryBaseUri?: string;
                activityData: ActivityTileProblem$activityData;
                artifactData?: ActivityTileProblem$artifactData;
                type?: string;
                hideActions?: boolean;
                hideSubmitter?: boolean;
                hideDate?: boolean;
            ...
            function ActivityTileProblem(props: ActivityTileProblem$Props): any;
            ...
            interface ActivityTileWarning$activityData {
            }
            interface ActivityTileWarning$artifactData {
            }
            interface ActivityTileWarning$Props {
                territoryBaseUri?: string;
                activityData: ActivityTileWarning$activityData;
                artifactData?: ActivityTileWarning$artifactData;
                type?: string;
                hideActions?: boolean;
                hideSubmitter?: boolean;
                hideDate?: boolean;
            ...
            function ActivityTileWarning(props: ActivityTileWarning$Props): any;
            interface AddNote$activityDto {
            }
            interface AddNote$activity {
            }
            interface AddNote$Props {
                activityDto?: AddNote$activityDto;
                ...
                leftPanel?: any;
                leftPanelGetValuesFn?(...args: any): any;
                hideImportanceSelection?: boolean;
                detailInfoSubmitterLabel?: string;
                requireDesc?: boolean;
            }
            function AddNote(props: AddNote$Props): any;
            interface DetailChat$activityDto {
            }
            interface DetailChat$Props {
                artifactId?: string;
                activityId?: string;
                artifactCode?: string;
                territoryBaseUri?: string;
                ...
                reactivateSolver?(...args: any): any;
                reloadActivity?(...args: any): any;
                activityDto?: DetailChat$activityDto;
            }
            function DetailChat(props: DetailChat$Props): any;
            ...
            interface DetailProblem$activityDto {
            }
            interface DetailProblem$Props {
                artifactId?: string;
                activityId?: string;
                artifactCode?: string;
                territoryBaseUri?: string;
                ...
                reactivateSolver?(...args: any): any;
                reloadActivity?(...args: any): any;
                activityDto?: DetailProblem$activityDto;
            }
            function DetailProblem(props: DetailProblem$Props): any;
            ...
            interface DetailWarning$activityDto {
            }
            interface DetailWarning$Props {
                artifactId?: string;
                activityId?: string;
                artifactCode?: string;
                territoryBaseUri?: string;
                ...
                reactivateSolver?(...args: any): any;
                reloadActivity?(...args: any): any;
                activityDto?: DetailWarning$activityDto;
            }
            function DetailWarning(props: DetailWarning$Props): any;
            ...
            function ActivityNews(props: ActivityNews$Props): any;
            const ParticipantSelector: any;
            interface DualWeightText$Props {
                primaryText?: string;
                secondaryText?: string;
                primaryWeight?: string;
            }
            function DualWeightText(props: DualWeightText$Props): any;
            interface RoleSelectorItem$Props {
                name?: string;
                code?: string;
                icon?: string;
                uuIdentity?: string;
            ...
            function RoleSelectorItem(props: RoleSelectorItem$Props): any;
        }
        namespace Routes {
        ...
        namespace Dw {
            interface Custom$dwRecord {
            }
            interface Custom$dwActionsMap {
            }
            interface Custom$modal {
            }
            interface Custom$alertBus {
            }
            interface Custom$Props {
                dwRecord?: Custom$dwRecord;
                type?: string;
                dwActionsMap?: Custom$dwActionsMap;
                getDefaultActions?(...args: any): any;
                rowHeight?: number;
                handleMeasure?(...args: any): any;
                selectable?: boolean;
                selected?: boolean;
                ...
                modal?: Custom$modal;
                alertBus?: Custom$alertBus;
                actionList?: any[];
            }
            function Custom(props: Custom$Props): any;
            interface Decide$dwRecord {
            }
            interface Decide$dwActionsMap {
            }
            interface Decide$modal {
            }
            interface Decide$confirmModal {
            }
            interface Decide$alertBus {
            }
            interface Decide$Props {
                dwRecord?: Decide$dwRecord;
                type?: string;
                dwActionsMap?: Decide$dwActionsMap;
                getDefaultActions?(...args: any): any;
                rowHeight?: number;
                handleMeasure?(...args: any): any;
                selectable?: boolean;
                ...
                onSetData?(...args: any): any;
                modal?: Decide$modal;
                confirmModal?: Decide$confirmModal;
                alertBus?: Decide$alertBus;
            }
            function Decide(props: Decide$Props): any;
            interface DoIt$dwRecord {
            }
            interface DoIt$dwActionsMap {
            }
            interface DoIt$modal {
            }
            interface DoIt$confirmModal {
            }
            interface DoIt$alertBus {
            }
            interface DoIt$Props {
                dwRecord?: DoIt$dwRecord;
                type?: string;
                dwActionsMap?: DoIt$dwActionsMap;
                getDefaultActions?(...args: any): any;
                rowHeight?: number;
                handleMeasure?(...args: any): any;
                selectable?: boolean;
                ...
                onSetData?(...args: any): any;
                modal?: DoIt$modal;
                confirmModal?: DoIt$confirmModal;
                alertBus?: DoIt$alertBus;
            }
            function DoIt(props: DoIt$Props): any;
            interface Info$dwRecord {
            }
            interface Info$dwActionsMap {
            }
            interface Info$modal {
            }
            interface Info$confirmModal {
            }
            interface Info$alertBus {
            }
            interface Info$Props {
                dwRecord?: Info$dwRecord;
                type?: string;
                dwActionsMap?: Info$dwActionsMap;
                getDefaultActions?(...args: any): any;
                rowHeight?: number;
                handleMeasure?(...args: any): any;
                selectable?: boolean;
                ...
                onSetData?(...args: any): any;
                modal?: Info$modal;
                confirmModal?: Info$confirmModal;
                alertBus?: Info$alertBus;
            }
            function Info(props: Info$Props): any;
            interface Chat$dwRecord {
            }
            interface Chat$dwActionsMap {
            }
            interface Chat$modal {
            }
            interface Chat$confirmModal {
            }
            interface Chat$alertBus {
            }
            interface Chat$Props {
                dwRecord?: Chat$dwRecord;
                type?: string;
                dwActionsMap?: Chat$dwActionsMap;
                getDefaultActions?(...args: any): any;
                rowHeight?: number;
                handleMeasure?(...args: any): any;
                selectable?: boolean;
                ...
                alertBus?: Chat$alertBus;
            }
            function Chat(props: Chat$Props): any;
            interface Milestone$dwRecord {
            }
            interface Milestone$dwActionsMap {
            }
            interface Milestone$modal {
            }
            interface Milestone$confirmModal {
            }
            interface Milestone$alertBus {
            }
            interface Milestone$Props {
                dwRecord?: Milestone$dwRecord;
                type?: string;
                dwActionsMap?: Milestone$dwActionsMap;
                getDefaultActions?(...args: any): any;
                rowHeight?: number;
                handleMeasure?(...args: any): any;
                selectable?: boolean;
                ...
                confirmModal?: Milestone$confirmModal;
                alertBus?: Milestone$alertBus;
            }
            function Milestone(props: Milestone$Props): any;
            interface Problem$dwRecord {
            }
            interface Problem$dwActionsMap {
            }
            interface Problem$modal {
            }
            interface Problem$confirmModal {
            }
            interface Problem$alertBus {
            }
            interface Problem$Props {
                dwRecord?: Problem$dwRecord;
                type?: string;
                dwActionsMap?: Problem$dwActionsMap;
                getDefaultActions?(...args: any): any;
                rowHeight?: number;
                handleMeasure?(...args: any): any;
                selectable?: boolean;
                ...
                onSetData?(...args: any): any;
                modal?: Problem$modal;
                confirmModal?: Problem$confirmModal;
                alertBus?: Problem$alertBus;
            }
            function Problem(props: Problem$Props): any;
            interface ReserveTime$dwRecord {
            }
            interface ReserveTime$dwActionsMap {
            }
            interface ReserveTime$modal {
            }
            interface ReserveTime$confirmModal {
            }
            interface ReserveTime$alertBus {
            }
            interface ReserveTime$Props {
                dwRecord?: ReserveTime$dwRecord;
                type?: string;
                dwActionsMap?: ReserveTime$dwActionsMap;
                getDefaultActions?(...args: any): any;
                rowHeight?: number;
                handleMeasure?(...args: any): any;
                selectable?: boolean;
                ...
                showActions?: boolean;
                onSetData?(...args: any): any;
                modal?: ReserveTime$modal;
                confirmModal?: ReserveTime$confirmModal;
                alertBus?: ReserveTime$alertBus;
            }
            function ReserveTime(props: ReserveTime$Props): any;
            interface Warning$dwRecord {
            }
            interface Warning$dwActionsMap {
            }
            interface Warning$modal {
            }
            interface Warning$confirmModal {
            }
            interface Warning$alertBus {
            }
            interface Warning$Props {
                dwRecord?: Warning$dwRecord;
                type?: string;
                dwActionsMap?: Warning$dwActionsMap;
                getDefaultActions?(...args: any): any;
                rowHeight?: number;
                handleMeasure?(...args: any): any;
                selectable?: boolean;
                ...
                onSetData?(...args: any): any;
                modal?: Warning$modal;
                confirmModal?: Warning$confirmModal;
                alertBus?: Warning$alertBus;
            }
            function Warning(props: Warning$Props): any;
        }
        namespace Forms {
            namespace AddSolver {
            ...
            namespace CreateActivity {
                ...
                interface Content$modal {
                }
                interface Content$activityType {
                }
                interface Content$activityData {
                }
                interface Content$Props {
    ...
    namespace Bricks {
        namespace Bricks {
            ...
            interface ArtifactLink$Props {
                ...
                copyComponentTag?: ((...args: any)=>any) | string;
                bgStyle?: "filled" | "outline" | "transparent" | "underline";
                borderRadius?: string;
                elevation?: "-1" | "0" | "1" | "2" | "3" | "4" | "5" | -1 | 0 | 1 | 2 | 3 | 4 | 5;
                hideIcon?: boolean;
            ...
            interface ArtifactLocationInfo$territoryName {
            }
            interface ArtifactLocationInfo$context {
            }
            interface ArtifactLocationInfo$Props {
                territoryBaseUri: string;
                artifactData: ArtifactLocationInfo$artifactData;
                territoryName: string | ArtifactLocationInfo$territoryName;
                routeName?: string;
                disableNavigation?: boolean;
                hideNavigation?: boolean;
                context?: ArtifactLocationInfo$context;
            }
            ...
            interface AppGroupCastList$artifactData {
            }
            interface AppGroupCastList$territoryData {
            }
            interface AppGroupCastList$castListData {
            }
            interface AppGroupCastList$Props {
                artifactData?: AppGroupCastList$artifactData;
                territoryData?: AppGroupCastList$territoryData;
                castListData?: AppGroupCastList$castListData;
                territoryBaseUri?: string;
                showIcon?: boolean;
            }
            function AppGroupCastList(props: AppGroupCastList$Props): any;
            interface DataStateResolver$dataResult {
            }
            interface DataStateResolver$customErrorLsi {
            }
            interface DataStateResolver$Props {
                dataResult: DataStateResolver$dataResult;
                children: ((...args: any)=>any) | any;
                customErrorLsi?: DataStateResolver$customErrorLsi;
            }
            function DataStateResolver(props: DataStateResolver$Props): any;
        }
    }
    namespace ArtifactIfc {
        namespace Bricks {
            ...
            function ArtifactLink(props: ArtifactLink$Props): any;
            interface ArtifactSearch$Props {
                territoryBaseUri?: string;
                hideCopyComponent?: boolean;
                showDefaultHeader?: boolean;
            }
            function ArtifactSearch(props: ArtifactSearch$Props): any;
            ...
            interface PermissionManagement$header {
            }
            interface PermissionManagement$help {
            }
            interface PermissionManagement$Props {
                artifactId?: string;
                artifactCode?: string;
                nestingLevel?: string;
                artifactUri?: string;
                ...
                elevationHover?: number;
                showDefaultHeader?: boolean;
                header?: PermissionManagement$header | string;
                bgStyle?: "filled" | "outline" | "transparent" | "underline";
                borderRadius?: number | string;
                colorSchema?: string;
                cardView?: boolean;
                ...
                contextType?: "basic" | "full" | "none";
                contextExpanded?: boolean;
                help?: PermissionManagement$help | string;
                helpHidden?: boolean;
                hideUnitAccessChecker?: boolean;
                copyTagFunc?(...args: any): any;
                padding?: string;
            ...
            function PermissionManagement(props: PermissionManagement$Props): any;
            interface ExplicitPermissions$header {
            }
            interface ExplicitPermissions$help {
            }
            interface ExplicitPermissions$Props {
                ...
                elevationHover?: number;
                showDefaultHeader?: boolean;
                header?: ExplicitPermissions$header | string;
                bgStyle?: "filled" | "outline" | "transparent" | "underline";
                borderRadius?: number | string;
                colorSchema?: string;
                cardView?: boolean;
                height?: number;
                help?: ExplicitPermissions$help | string;
                helpHidden?: boolean;
                hideActions?: boolean;
                nestingLevel?: string;
                contextType?: "basic" | "full" | "none";
            ...
            interface UserPreference$Props {
                baseUri?: string;
                componentCode?: string;
                componentTag?: string;
            }
            function UserPreference(props: UserPreference$Props): any;
        ...
        namespace Core {
            ...
            function PermissionSettings(props: PermissionSettings$Props): any;
            interface PermissionManagementBody$header {
            }
            interface PermissionManagementBody$help {
            }
            interface PermissionManagementBody$Props {
                artifactId?: string;
                artifactCode?: string;
                nestingLevel?: string;
                territoryBaseUri?: string;
                ...
                elevationHover?: number;
                showDefaultHeader?: boolean;
                header?: PermissionManagementBody$header | string;
                bgStyle?: "filled" | "outline" | "transparent" | "underline";
                borderRadius?: number | string;
                colorSchema?: string;
                cardView?: boolean;
                height?: number;
                help?: PermissionManagementBody$help | string;
                helpHidden?: boolean;
                hideUnitAccessChecker?: boolean;
                copyTagFunc?(...args: any): any;
                contextType?: "basic" | "full" | "none";
            ...
            function PermissionManagementBody(props: PermissionManagementBody$Props): any;
    ...
    namespace Folder {
        ...
        namespace Core {
            ...
            interface ExplorerStructureTree$artifact {
            }
            interface ExplorerStructureTree$Props {
                onClick?(...args: any): any;
                onCtrlClick?(...args: any): any;
                onWheelClick?(...args: any): any;
                artifact?: ExplorerStructureTree$artifact;
                territoryBaseUri?: string;
                allowUpperBrowsing?: boolean;
                includeRoot?: boolean;
                showContext?: boolean;
            ...
            function ExplorerStructureTree(props: ExplorerStructureTree$Props): any;
        }
        namespace Context {
    ...
    namespace Vendor {
        ...
        namespace Bricks {
            ...
            function UnitAccessChecker(props: UnitAccessChecker$Props): any;
            interface DirectCastBySideA$header {
            }
            interface DirectCastBySideA$help {
            }
            interface DirectCastBySideA$Props {
                artifactId?: string;
                artifactCode?: string;
                nestingLevel?: string;
                artifactUri?: string;
                ...
                elevationHover?: number;
                showDefaultHeader?: boolean;
                header?: DirectCastBySideA$header | string;
                bgStyle?: "filled" | "outline" | "transparent" | "underline";
                borderRadius?: number | string;
                colorSchema?: string;
                cardView?: boolean;
                ...
                contextType?: "basic" | "full" | "none";
                contextExpanded?: boolean;
                help?: DirectCastBySideA$help | string;
                helpHidden?: boolean;
                hideUnitAccessChecker?: boolean;
                copyTagFunc?(...args: any): any;
                padding?: string;
            ...
            function DirectCastBySideA(props: DirectCastBySideA$Props): any;
        }
    }
    namespace App {
        namespace Routes {
    ...
    namespace EventBroker {
        namespace Bricks {
            interface JobProgress$header {
            }
            interface JobProgress$Props {
                header?: JobProgress$header | string;
                consoleBaseUri: string;
                eventBrokerAsid: string;
                cardView?: boolean;
                colorSchema?: string;
                elevation?: any;
                borderRadius?: any;
            ...
            function JobProgress(props: JobProgress$Props): any;
            interface DispatchProgress$header {
            }
            interface DispatchProgress$Props {
                header?: DispatchProgress$header | string;
                consoleBaseUri: string;
                eventBrokerAsid: string;
                cardView?: boolean;
                colorSchema?: string;
            ...
            function DispatchProgress(props: DispatchProgress$Props): any;
        }
        namespace Core {
            interface JobProgress$header {
            }
