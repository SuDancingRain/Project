...
declare namespace UU5 {
    namespace Common {
        ...
        const Tools: {
            ...
            error(msg: any, context: any, _logger?: any): any;
            warning(msg: any, context: any, _logger?: any): any;
            ...
            getWeekNumber(date: any, startOfWeek?: number): any;
            ...
            getCsrfToken(): any;
            getAuthenticatedUrl(url: any, session: any, accessToken?: any, csrfToken?: any): Promise<any>;
            getAuthenticatedHeaders(url: any, session: any, accessToken?: any, csrfToken?: any): Promise<any>;
            deepSortObjectKeys(object: any): any;
            groupCall(uri: any, dtoIn: any, doLoadFn: any, _?: Tools$groupCall$3): any;
        ...
        const Redirect: any;
        const Context: any;
        const TimeZoneContext: any;
        const UserPreferencesContext: any;
    ...
    namespace Bricks {
        ...
        interface Modal$Props {
            ...
            registerToModalBus?: boolean;
            fullscreen?: boolean;
            _render?(...args: any): any;
            _allowClose?(...args: any): any;
        }
        ...
        interface DateTime$Props {
            ...
            _contextTimeZone?: string;
            _contextFormat?: string;
        }
        ...
        interface Video$Props {
            ...
            authenticate?: boolean;
            onBeforeChunkLoad?(...args: any): any;
        }
        ...
        const Factory: {
            createTag(tag: any, uu5Name: any, className: any, defaultContent: any, levelFrom: any, levelTo: any, InlineComponent: any): any;
        ...
        const LinkUnicornUniversity: any;
        ...
        function ModalBus(props: any): any;
        const bookKitUrl: "https://uuos9.plus4u.net/uu-bookkitg01-main/78462435-ed11ec379073476db0aa295ad6c00178/book/page";
        const Error: any;
    }
    ...
    namespace Forms {
        function FormControls(props: any): any;
        const bookKitUrl: "https://uuos9.plus4u.net/uu-bookkitg01-main/78462435-ed11ec379073476db0aa295ad6c00178/book/page";
        const ChoiceMixin: {
            propTypes: {
                placeholder?: any;
        ...
        const FormMixin: {
            ...
            propTypes: {
                ...
                disableValidationAlert?: boolean;
            };
            getDefaultProps(): any;
            getInitialState(): any;
            UNSAFE_componentWillMount(): any;
        ...
        interface DateRangePicker$Props {
            ...
            monthNameFormat?: "abbr" | "roman";
            popoverLocation?: "local" | "portal";
            strictSelection?: string | number;
            weekStartDay?: 1 | 2 | 3 | 4 | 5 | 6 | 7;
            valueType?: "date" | "iso";
            allowUnspecifiedRange?: boolean | "from" | "to";
        ...
        interface DateTimeRangePicker$Props {
            ...
            popoverLocation?: "local" | "portal";
            weekStartDay?: 1 | 2 | 3 | 4 | 5 | 6 | 7;
            valueType?: "date" | "iso" | "isoLocal";
            allowUnspecifiedRange?: boolean | "from" | "to";
            hideResetButton?: boolean;
            timeFromDefault?: string;
        ...
        interface IconPicker$categories$label {
        }
        interface IconPicker$categories$iconList {
            icon?: string;
            state?: string;
            component?(...args: any): any;
            code?: string;
        }
        interface IconPicker$categories {
            code?: string;
            label?: any | IconPicker$categories$label;
            iconList?: (string | IconPicker$categories$iconList)[];
        }
        interface IconPicker$value {
            icon?: string;
            state?: string;
        }
        interface IconPicker$Props {
            disableBackdrop?: boolean;
            categories?: (string | IconPicker$categories)[];
            selectedCategory?: string;
            placeholder?: string;
            required?: boolean;
            requiredMessage?: any;
            value?: string | IconPicker$value;
            borderRadius?: string;
            bgStyle?: "filled" | "outline" | "transparent" | "underline";
            elevation?: "-1" | "0" | "1" | "2" | "3" | "4" | "5" | -1 | 0 | 1 | 2 | 3 | 4 | 5;
            openToContent?: boolean | string;
    ...
    namespace Hooks {
        ...
        const createComponentWithRef: any;
        const createVisualComponent: any;
        const createVisualComponentWithRef: any;
        const createHoc: any;
        function useCall(...hookArgs: any): any;
        ...
        function useUserPreferences(...hookArgs: any): any;
        function UserPreferencesProvider(props: any): any;
        const useDataController: any;
        const DataControllerProvider: any;
        const useDataFilter: any;
        const useDataSelection: any;
        const useDataSorter: any;
        const useDataStore: any;
        const DataStoreProvider: any;
        const useDevice: any;
        const DeviceProvider: any;
        const useElementSize: any;
        const useEvent: any;
        const useLsi: any;
        const useLsiValues: any;
        const usePreviousValue: any;
        const usePrint: any;
        const useStickyTop: any;
        const useUnmountedRef: any;
        const useDataObject: any;
        const useDataList: any;
        interface useData$0 {
            onLoad?: any;
            onUpdate?: any;
            dtoIn?: any;
